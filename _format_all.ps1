...
Get-ChildItem -Recurse -Include *.py -Path agents, scenarios, tools, utils, monitoring, scenario_engine | ForEach-Object { isort $_.FullName }
Get-ChildItem -Recurse -Include *.py -Path agents, scenarios, tools, utils, monitoring, scenario_engine | ForEach-Object { black --line-length=120 $_.FullName }
