...
class ModifyCodeOrchestratorAgent(OrchestratorAgentBase):
    ...
    def __init__(
        ...
        self._developer_agent = DeveloperAgent(config=config, scenario_type=ScenarioType.MODIFY_CODE)
        self._reviewer_agent = ReviewerAgent(config=config, scenario_type=ScenarioType.MODIFY_CODE)
